                            ...
                            <Formik
                                ...
                                {({ errors, status, touched, isSubmitting }) => (
                                    <Form>
                                        ...
                                        <div className="loadCircleDiv">
                                            <button className="marronButton" type="submit" disabled={isSubmitting}>Se connecter</button>
                                            {isSubmitting &&
                                            <img className="loadCircle" src="data:image/gif;base64," />
                                            }
                                        </div>
                                        {status &&
                                        <div>{status}</div>
