...
export const locationCompassService = {
    locationCompass,
    stopCompass
};
...
function bearingListener(eventData) {
    ...
    navigator.geolocation.getCurrentPosition(position => {
        let fromNorthBearing = getBearing(position.coords.latitude, position.coords.longitude, latbis, longbis);
        let bearedDir = dir + getBearing(position.coords.latitude, position.coords.longitude, latbis, longbis);
